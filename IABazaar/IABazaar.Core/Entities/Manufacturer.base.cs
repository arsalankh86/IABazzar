...
{
	[Serializable]	
	public abstract partial class ManufacturerBase:EntityBase, IEquatable<ManufacturerBase>
	{
			
		[PrimaryKey]
		public System.Int32 ManufacturerId{ get; set; }

		public System.Guid ManufacturerGuid{ get; set; }
		...
		public System.Int32 ParentManufacturerId{ get; set; }
		...
		#region IEquatable<ManufacturerBase> Members

        public virtual bool Equals(ManufacturerBase other)
        {
			if(this.ManufacturerId==other.ManufacturerId  && this.ManufacturerGuid==other.ManufacturerGuid  && this.Name==other.Name  && this.SeName==other.SeName  && this.SeKeywords==other.SeKeywords  && this.SeDescription==other.SeDescription  && this.SeTitle==other.SeTitle  && this.SeNoScript==other.SeNoScript  && this.SeAltText==other.SeAltText  && this.Address1==other.Address1  && this.Address2==other.Address2  && this.Suite==other.Suite  && this.City==other.City  && this.State==other.State  && this.ZipCode==other.ZipCode  && this.Country==other.Country  && this.Phone==other.Phone  && this.Fax==other.Fax  && this.Url==other.Url  && this.Email==other.Email  && this.QuantityDiscountId==other.QuantityDiscountId  && this.SortByLooks==other.SortByLooks  && this.Summary==other.Summary  && this.Description==other.Description  && this.Notes==other.Notes  && this.RelatedDocuments==other.RelatedDocuments  && this.XmlPackage==other.XmlPackage  && this.ColWidth==other.ColWidth  && this.DisplayOrder==other.DisplayOrder  && this.ExtensionData==other.ExtensionData  && this.ContentsBgColor==other.ContentsBgColor  && this.PageBgColor==other.PageBgColor  && this.GraphicsColor==other.GraphicsColor  && this.ImageFilenameOverride==other.ImageFilenameOverride  && this.Published==other.Published  && this.Wholesale==other.Wholesale  && this.ParentManufacturerId==other.ParentManufacturerId  && this.IsImport==other.IsImport  && this.Deleted==other.Deleted  && this.CreatedOn==other.CreatedOn  && this.PageSize==other.PageSize  && this.SkinId==other.SkinId  && this.TemplateName==other.TemplateName )
			{
				return true;
			}
			else
