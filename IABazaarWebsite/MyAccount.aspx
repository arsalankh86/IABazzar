...
<div class="breadcrumb">
        <a href="Default.aspx" title="Home">Home</a>
         &raquo; <a href="MyAccount.aspx" title="My Account">Account</a>
      </div>
  ...
  <div class="content">
    <ul class="list-bullet">
       <li><a href="personalInfor.aspx" title="">Personal Information</a></li>
       <li><a href="OrderInfomation.aspx" title="">Order History</a></li>
       <li><a href="Wishlist.aspx" title="">Wish Lish</a></li>
      <li><a href="#" title="Edit your account information">Edit your account information</a></li>
      <li><a href="#" title="Change your password">Change your password</a></li>
      <li><a href="#" title="Modify your address book entries">Modify your address book entries</a></li>
      <li><a href="#" title="Modify your wish list">Modify your wish list</a></li>
    </ul>
  </div>
  <h2>My Orders</h2>
  <div class="content">
   <ul class="list-bullet">
      <li><a href="#" title="View your order history">View your order history</a></li>
      <li><a href="#" title="Downloads">Downloads</a></li>
            <li><a href="#" title="Your Reward Points">Your Reward Points</a></li>
            <li><a href="#" title="View your return requests">View your return requests</a></li>
      <li><a href="#" title="Your Transactions">Your Transactions</a></li>
    </ul>
  </div>
  <h2>Newsletter</h2>
  <div class="content">
    <ul class="list-bullet">
      <li><a href="#" title="Subscribe / unsubscribe to newsletter">Subscribe / unsubscribe to newsletter</a></li>
    </ul>
  </div>
  </div>
<div class="clear"></div>
